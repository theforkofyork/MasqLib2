...
public class TankDrive implements PID_Constants, Sensor_Thresholds {
    ...
    public Servo capClamp = new Servo("capClamp");
    public Servo liftClamp = new Servo("liftClamp");
    public LiftSystem lift = new LiftSystem("liftMotor1", "liftMotor2");
    ...
    //ColorSensor
    public I2CColorSensor beaconColor = new I2CColorSensor("Beacon", 60);
    //RangeSensor
